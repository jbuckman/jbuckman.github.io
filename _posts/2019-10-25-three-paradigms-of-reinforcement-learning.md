...
"Model-based methods are more sample efficient that model-free methods." This oft-repeated maxim has reared its head in almost every model-based RL paper in recent years ([including Jacob's](https://arxiv.org/pdf/1807.01675.pdf)). It’s such common knowledge that nobody even bothers including a citation alongside -- the truth of the statement is taken as self-evident. It’s obvious...and yet it is false. In fact, in many cases, the sample-efficiency of the two approaches is identical.
