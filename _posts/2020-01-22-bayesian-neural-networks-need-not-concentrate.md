...
*Many thanks to everyone who gave us feedback on the first version of this blog post. Hit us up on Twitter ([Carles](https://twitter.com/carlesgelada) and [Jacob](https://twitter.com/jacobmbuckman)) to continue the discussion! Also, follow me on [Substack](https://jacobbuckman.substack.com/) for more writing. To cite this post, please use please use the following BibTeX:*
```
 @misc{blogpost,
  title={Bayesian Neural Networks Need Not COncentrate},
