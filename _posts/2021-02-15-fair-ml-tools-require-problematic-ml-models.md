...
No, more concerning to me is the second-most-common type of reaction.
Many people commented some variation of "this is unfortunate but expected behavior, and we can fix it by modifying the training procedure."
...
Optimism on whether it is fixable varies; so do people's intuitions about possible solutions.
...
Others say that this issue stems from some algorithmic decisions made by OpenAI, and maybe would suggest some form of regularization or an alternative training objective.[^0]
This is a position that many serious AI researchers have likely adopted.
And it, too, is wrong.
